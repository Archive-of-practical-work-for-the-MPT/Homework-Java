...
public class MainActivity extends AppCompatActivity {
    ...
    private static final String SENDER_EMAIL = "почта"; // у почты в разделе безопасность включите галочку в "Ненадежные приложения, у которых есть доступ к аккаунту"
    private static final String SENDER_PASSWORD = "пароль";
