    ...
    private void registerUser() {
        ...
        mAuth.createUserWithEmailAndPassword(email, password).addOnCompleteListener(this, task->{
            if(task.isSuccessful()){
                ...
                Toast.makeText(LoginActivity.this, "Такая почта уже есть в системе", Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    private void saveUserFirestore(String email) {
        ...
        db.collection("users").document(mAuth.getCurrentUser().getUid())
                ...
                .addOnFailureListener(e -> {
                    Toast.makeText(LoginActivity.this, "Ошибка регистрации - анлак" + e.getMessage(), Toast.LENGTH_SHORT).show();
                });
    }
}
